...
async function sendEmail(sendInfo) {
  try {
    ...
    let info = await transporter.sendMail({
      ...
      text: `您在《CorderX》社区中注册，您的邀请码是${sendInfo.code},邀请码的过期时间: ${sendInfo.expire}`, // plain text body
      html: `
        <div style="border: 1px solid #dcdcdc;color: #676767;width: 600px; margin: 0 auto; padding-bottom: 50px;position: relative;">
          ...
          <div style="padding: 25px">
            ...
            <a href="javascript:;" style="padding: 10px 20px; color: #fff; background: #009e94; display: inline-block;margin: 15px 0;">立即重置密码</a>
